...
canvas.setDimensions({width:700, height:500});
...
//File Upload
$scope.addImage = document.getElementById('file').addEventListener("change", function (e) {
...
$scope.SendData = function () {
        $scope.name;
        var template = [{id: $scope.name, data: ""}];
